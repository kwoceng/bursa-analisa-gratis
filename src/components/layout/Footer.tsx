        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Platform edukasi analisa Bursa Efek Indonesia. Data harga, berita pasar, dan
              watchlist pribadi — bebas biaya untuk semua.
            </p>
          </div>
          <div>
            <h4 className="text-sm font-semibold text-foreground">Navigasi</h4>
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              <li><Link to="/saham" className="hover:text-foreground">Daftar Saham</Link></li>
              <li><Link to="/berita" className="hover:text-foreground">Berita Pasar</Link></li>
          ...
          <div>
            ...
            <p className="mt-3 text-xs leading-relaxed text-muted-foreground">
              ...
              perdagangan aktual di BEI. Konten yang ditampilkan bukan rekomendasi jual/beli
              maupun nasihat investasi. Segala keputusan investasi adalah tanggung jawab
              pengguna.
            </p>
          </div>
        </div>
